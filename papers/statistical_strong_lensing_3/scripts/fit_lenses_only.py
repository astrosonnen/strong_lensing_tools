...
for i in range(nlens):
    ...
    mag_integrals.append(group['mag_integral_grid'][()])

# now runs the inference

gamma_mu_par = {'name': 'gamma_mu', 'lower': 1.8, 'upper': 2.2, 'guess': 2., 'spread': 0.01}
gamma_sig_par = {'name': 'gamma_sig', 'lower': 0., 'upper': 0.5, 'guess': 0.2, 'spread': 0.01}
...
output_file = h5py.File('../chains/%s_lenses_only_inference.hdf5'%mockname, 'w')
