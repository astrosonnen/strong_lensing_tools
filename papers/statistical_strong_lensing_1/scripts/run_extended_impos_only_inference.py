...
def logpfunc(p):
    ...
    for i in range(ngal):
        ...
        full_integrand = msps_term * msps_like * reff_term * mdm5_term * beta_prior * abs(detJ_grids[i]) * gammadm_term
...
output_file = h5py.File('../chains/extended_impos_only_inference.hdf5', 'w')
