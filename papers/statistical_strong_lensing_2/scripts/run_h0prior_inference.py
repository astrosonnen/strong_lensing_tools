...
def logpfunc(p):
    ...
    sumlogp = -0.5*(h0 - h0_prior_mu)**2/h0_prior_sig**2
...
sampler = emcee.EnsembleSampler(nwalkers, npars, logpfunc, threads=16)
...
output_file = h5py.File('chains/%s_h0prior_inference.hdf5'%mockname, 'w')
